...
public class ShowMessageList extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		int pageCount=adminManager.getMessagePageCountById(pageSize, userid);
		...
		ArrayList al=adminManager.getMessagesByPageById(pageNow, pageSize, userid);
		int count = adminManager.getMessageCount(userid);
