...
<c:if test="${empty messages}">
   ...
   <c:if test="${!empty messages}">
 <form id="form1" name="form1" method="post" action="usercomplete.do?method=LookUserComplete&pageNow=${pageNow}">
	   <p align="center">
	   <c:if test="${pageNow>1}">
	   <a href="usercomplete.do?method=LookUserComplete&pageNow=1">第一页</a> || 
	   <a href="usercomplete.do?method=LookUserComplete&pageNow=${pageNow-1}">上一页</a> ||
	   </c:if>
	   <c:if test="${pageNow<pageCount}">
	    <a href="usercomplete.do?method=LookUserComplete&pageNow=${pageNow+1}">下一页</a> 
	    || <a href="usercomplete.do?method=LookUserComplete&pageNow=${pageCount}">最后一页</a> 
	   </c:if>
