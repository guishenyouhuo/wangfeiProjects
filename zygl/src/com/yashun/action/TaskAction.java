...
public class TaskAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		int pageCount = um.getPageCountByTime(pageSize, user_num, time);
		...
		ArrayList al = um.getMessagesByTime(time, user_num, pageNow, pageSize);
		int count = um.getCountByTime(user_num, time);
