...
<form id="form1" name="form1" method="post" action="serach2.do?method=byTel">
  <div align="center">按电话搜索
  ：
    <label>
    <input name="tel" type="text" id="tel" size="20" maxlength="20"  autocomplete="off" onkeyup="checkLength();"/>
    </label>
...
<!-- <p></p><p></p> -->
<!-- <form id="form2" name="form2" method="post" action="serach2.do?method=byId"> -->
...
<!-- </form> -->
<!-- <p></p><p></p> -->
<!-- <form id="form3" name="form3" method="post" action="serach2.do?method=byName"> -->
