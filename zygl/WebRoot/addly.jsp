...
$(function(){
	$("#subBtn").click(function(){
		...
		$.post("admin_add.do?method=checkExist",{"tel":tel},function(data){
			if(data==1)
			{
				alert("已经存在不能重复添加。");
			}
...
<body>
<form id="form1" name="form1" method="post" action="admin_add.do?method=addMessage" onsubmit="return dosubmit();">
<!--  <p>&nbsp;</p>
...
<tr>
    ...
    <c:if test="${!empty users}">
    	<tr>
	      <td height="25"><div align="right">分配给：</div></td>
	      <td><label>
    ...
    <tr><td>来源：</td><td><label>
        <input name="fromtag" type="text" id="fromtag" size="40" />
      </label></td></tr>
    <tr>
