...
<p align="center">查看所有留言</p>
 ...
 <form id="form1" name="form1" method="post" action="jumppage.asp">
   <p align="center"><A HREF="#">第一页</A> <A HREF="#">前一页</A> <A HREF="#">下一页</A> <A HREF="#">最后一页</A> 【共 0 条留言·当前在 0 页·共 0 页】 
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FF9900">
      <tr>
        ...
        <td width="165" rowspan="3" bgcolor="#FFFFFF"><iframe src="modifyren.jsp?num=11&id=11" width="165" height="24" frameborder="0" scrolling="no"></iframe></td>
      </tr>
      <tr>
